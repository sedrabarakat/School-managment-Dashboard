...
Widget Celander({
  ...
  return Container(
    ...
    height: (height < 700) ? height / 200 : height / 2.89 - height / 40,
    ...
    child: Padding(
      ...
      child: TableCalendar(
        calendarStyle: CalendarStyle(
            todayDecoration:
                Circle_BoxDecoration.copyWith(color: Colors.lightBlue)),
...
Widget financial_chart_container(
  height,
  width, {
  ...
  return Container(
    ...
    child: Padding(
      ...
      child: SfCartesianChart(
          ...
          primaryYAxis:
              NumericAxis(minimum: 0, maximum: max + 500, interval: 100),
...
Widget Newest_articals(context, height, width) {
  return Container(
    ...
    width: width / 5,
    padding:
        EdgeInsets.only(top: height / 30, left: width / 50, right: width / 60),
    decoration: CircularBorder_decoration.copyWith(
        borderRadius: BorderRadius.circular(50)),
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          'Newest articals',
          style:
              TextStyle(fontWeight: FontWeight.bold, fontSize: width * 0.014),
        ),
        SizedBox(
          height: height / 50,
        ),
      ...
      Expanded(
        child: Column(
          ...
          children: [
            ...
            Text(
              'hello every one its nice to post here  AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
