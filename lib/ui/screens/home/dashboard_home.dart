                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            number_container(height: height, width: width, icon: Icons.school, color: Colors.lightBlueAccent, catagory: 'Student', number: 200),
                            SizedBox(width: width / 30,),
                            number_container(height: height, width: width, icon: Icons.people_outline_rounded, color: Colors.lightBlue, catagory: 'Teacher', number: 100),
                            SizedBox(width: width / 40,),
                            number_container(height: height, width: width, icon: Icons.account_circle_rounded, color: Colors.blue, catagory: 'Admins', number: 50)
                          ],
                        ),
